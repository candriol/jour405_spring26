...
There is a very strong positive correlation between the DJIA and GDP. The 0.95 correlation coefficient is near max strength and the scatterplot confirms this. Each dot is close to the line and create a positive slope up to the right, showing the correlation strength between the two variables. 
