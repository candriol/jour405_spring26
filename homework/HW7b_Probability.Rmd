...
wh_paid |>
  ggplot() + 
  geom_histogram(aes(x = SALARY), bins = 30) +
  geom_vline(aes(xintercept = mean (SALARY)),
  color = "blue",
  linetype = "dashed") + 
  geom_vline(
    aes(xintercept = mean(SALARY) - sd(SALARY)),
    color = "red",
    linetype = "dashed"
  ) + 
...
ANSWER HERE: The distribution is not normal, it is skewed right. There isn't one place where most salaries are clustered. The biggest cluster of salaries looks to be between about $60,000 and $100,000 salaries, but there is a large number of individuals who hae salaries higher than the mean, especially around $120,000 and between $190,000 and $200,000. 
...
ANSWER HERE: The data follows the empirical rule closely. But the 65.9 percent being within one SD and 91.2 percent being within 2 SD prove the data isn't normal. Less of the data falls inside 1 and two standard deviations as less data is in the center of the distributing and more points are at extreme ends. 
...
ANSWER HERE: There is a an about 17% of White House employees are expected to make more than $150,000 a year which is lower than the 18 in the actual salary data. 
...
ANSWER HERE: The middle range tells us that most of the White House salaries cluster around the lower and middle end of the salary numbers for employees. This means that a small number of employees make a lot more or less than average making it the distribution somewhat skewed. 
...
ANSWER HERE: Reality differs most from a normal distribution's predictions for lower and middle salaries. More employees are expected to earn less than $60k and more oin the $60k to $90k range. The difference is explained by the data distribution being skewed right. A large number of employees are clustered between lower and middle range salaries so it doesn't perfectly match a normal data distribution. 
...
LEDE: About half of White House employees earn salaries between $80,000 and $120,000 a year while only 18% earn more than $150,000 according to the latest salary report. 

Story advance: I would advance the story by researching previous year's White House salaries and compare median and mean to show the skew of those distributions. This can help me find trends over team regarding the salaries of White House employees, and further look into salaries for specific departments or positions be hold and salaries have changed significantly for positions over time. 
