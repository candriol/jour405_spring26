...
Income and education have the most positive correlation with turnout. This shows how higher income counties and college graduates vote more often. Median age has a slight positive correlation too. There is a negative correlation with unemployment and leads to lower voter turnout. The percentage of white voters in the population are not correlated at all. 
...
I think the 80% variation is strong and the residuals being low and very close to zero means that the predictions were mostly correct. The white percentage of the population, median age and income are the most statistically significant predictors. The least significant are population, education and unemployment. I'd say this is a useful model because the numbers show the variation with voter turnout is statistically significant. 
...
The models that are significantly better than others are turnout and the white percentage of the population compared to when turnout is compared to income and population which are not strong. 
...
This analysis might identify which counties in Maryland's counties in relation to their demographics. More wealthy and educated counties typically have higher voter turnouts so if that isn't the case, I could research possible reasons as to why that might be. 
