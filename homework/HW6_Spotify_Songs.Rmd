...
spotify_songs |>
  ...
  geom_histogram(aes(x = danceability)) + 
  geom_vline(aes(xintercept = mean(danceability)), color = "blue", linetype = "dashed") +
  geom_vline(aes(xintercept = mean(danceability) - sd (danceability)), color = "red", linetype = "dashed") + 
  geom_vline(aes(xintercept = mean(danceability) - sd(danceability)), color = "red", linetype = "dashed")
...
More of the data is clustered to the right of the mean, therefore, the dataset shows danceability scores are slightly skewed left. The mean and standard deviation prove that songs on spotify have a stronger danceability on average because within one standard deviation left of the mean is songs with higher than a 0.5 score. With 0.5 meaning a song is in the middle between 100% danceable and not danceable at all, more than 75% of the data is above the 0.5 score with the peak number of songs reaching at a score of about .80. 
