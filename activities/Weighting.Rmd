...
The range of weights is from 0.23-3.04.

2. What does it mean when a respondent has a weight of 0.23? What about 3.04?

0.23 means that type of person was more frequent in the poll, while the 3.04 weight means that type of person was ofund less frequently. 

3. Why might some respondents be weighted more heavily than others?

The communities they are apart of are more or less common compared to others who took the poll 
...
The rarely/never category because they are the hardest to reach. 

2. How might these differences affect reporting on likely voter turnout?

Voter turnout is just the willingness of people to vote. People who choose not to vote won't and the numbers will skew differently without that group of people and are less likley to participate in the poll. 
...
A person might be respond that they are unlikely to vote then change their mind at election time. Therefore, they are the most underrepresented group in polls because data shows that they are less likely to vote. 
