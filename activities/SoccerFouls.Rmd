...
The scatter plot shows that there is almost no relationship between the number of fouls a soccer team commits and the results of their game (win vs loss). The nearly perfect straight horizontal line shows that there is a near-zero relationship between the variables. 
...
Answer: There is a slightly positive correlation between the number of corner kicks a team gets in a game with their win-loss record. They appear to effect if a teams wins or losses, but are not a huge factor in deciding the outcome. The correlation line shows is going up much more than it did in the plot comparing fouls and team outcomes.  
