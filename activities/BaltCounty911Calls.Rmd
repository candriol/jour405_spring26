...
ANSWER HERE: The patterns I notice are that the numbers increased and began to peak higher in the srping time. It also looks like the low numbers were well farther away from the mean than the high numbers. The horizontal lines would be drawn probably be between 11 and 15 calls. This would highlight the day of high frequency and low freqancy of calls best. 
...
ANSWER HERE: On avereage, Saturday's are the most frequent day where the number of overdoes calls is higher than average. 
...
ANSWER HERE: A potential angle is the figuring out what happened between July 14 and July 22. Those two days had the some of the highest number of overdose calls. Them happening within 8 days of each other could mean there was an event, or a bad batch of drugs that caused the problem. 
