...
I think the model is somewhat useful because it gives a solid idea about which factors are the biggest indicators of a team that wins more games. But the residuals being +4 and -4 in a 16 game sample size is certainty not ideal and makes it hard to fully tust this model. 
...
The data shows that points scored has the most impact on wins of those three factors. Yard gained is not impact at all. There was just a .44 correlation between yard gained and wins, and the team that led the league (the Cowboys) only won 8 games. 
...
I could use this model to cover a team or game to find which factor correlates to wins and losses the most for the team I'm covering. It would be different for a lot of teams. Some times are more offensive oriented and thrive when they move the ball while some teams lean on their defense and thrive in low scoring games. This would let fans of the team know the kind of game their team likely needs to play to have the best chance at winning. 
